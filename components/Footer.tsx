...
export default function Footer() {
  return (
    <footer className="bg-bakery-900 text-bakery-100 py-12 px-4">
      <div className="max-w-6xl mx-auto grid sm:grid-cols-3 gap-8">
        <div>
          ...
          <p className="text-sm text-bakery-300">
            Pan artesanal de pueblo, horneado con tradición desde Gualeguay,
            Entre Ríos.
          </p>
        </div>
        <div>
          <h4 className="font-bold text-white mb-4">Horarios</h4>
          <ul className="text-sm text-bakery-300 space-y-1">
            <li>Lun – Sáb: 7:00 a 20:00</li>
            <li>Dom: 8:00 a 13:00</li>
          </ul>
        </div>
        <div>
